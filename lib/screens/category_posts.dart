...
class CategoryPosts extends StatefulWidget {
  ...
  final String categoryID; //it needs to be final because once we pass it, it will not needed to be changed
      ...
      body: Container(
        ...
        child: FutureBuilder(
          ...
          builder: (BuildContext context , AsyncSnapshot<List<Post>> snapshot){
            ...
            return Container(
              child: Center(
                child: Text('No posts have been made on this category' , style: TextStyle(color: Colors.red),),
              ),
            );
          },
        ),
